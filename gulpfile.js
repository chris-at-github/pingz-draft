...
gulp.task('scripts', function() {
	...
	gulp.src(['./src/js/jquery-ui-1.10.3.min.js', './src/js/twitterbootstrap-2.0.4.js', './src/js/salvattore.js', './src/js/i18n/messages.de.js', './src/js/parsley-1.1.16.js', './src/js/lazyload-1.9.1.js', './src/js/pingz.functions.js'])
		.pipe(plumber())
